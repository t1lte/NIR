...
class Choreography:
    ...
    def _parse_element(self, element):
        split_tag = element.tag.split("}")[1]
        if split_tag in [member.value for member in
                         TerminalType.__members__.values()]:
            return
...
if __name__ == "__main__":
    ...
    choreography.load_diagram_from_xml_file("PizzaOrder.bpmn")
    print(choreography.graph)
